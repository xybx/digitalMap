    ...
    <vab-query-form>
      <vab-query-form-left-panel :span="24">
        <el-form :inline="true" ref="queryForm" :model="queryForm" @submit.native.prevent>
          ...
          <el-form-item v-if="frule!='codest'&&frule!='codeftf'" label="招生年度">
<!--            <el-input v-model="queryForm.annual" placeholder="" clearable />-->
            <el-date-picker v-model="queryForm.annual" type="year" value-format="yyyy" placeholder="选择招生年度" clearable :picker-options="pickerOptions" @change="yearsChange" />
          </el-form-item>
          ...
          <el-form-item v-if="frule!='codend'&&frule!='codeth'&&frule!='codefth'&&frule!='codeftf'" label="办学性质" prop="type">
            <el-select v-model="queryForm.type" placeholder="请选择办学性质" clearable :disabled="disabled">
          ...
          <el-form-item v-if="frule!='codend'&&frule!='codest'&&frule!='codefth'&&frule!='codeftf'" label="报名阶段">
            <el-select v-model="queryForm.applystage" placeholder="请选择报名阶段" clearable :disabled="disabled">
              ...
              <el-option :value="4" label="线下报名"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
            <el-button icon="el-icon-search" type="primary" size="small" @click="queryClick">查询</el-button>
            <el-button v-if="frule!='codend'&&frule!='codefth'" icon="el-icon-circle-plus-outline" type="success" plain size="small" @click="addClick">新增</el-button>
