...
<template>
  <div class="pwork">
    ...
    <pubdialog ref="public" @getData="getData" :types="0"/>
  </div>
</template>

<script>
import {delPublic, getPublicList} from '../api/public'
...
export default {
  ...
  methods: {
    async getData(){
      let params = {pagenum:this.pageNo,pagesize:this.pageSize,type:0}
