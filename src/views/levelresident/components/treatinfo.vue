    ...
    <el-form :model="treatData" :inline="true" status-icon label-width="125px">
      <div class="itembox">
        ...
        <el-form-item label="残疾证号">
          <el-input v-model="treatData.disabilitynumber" :readonly="sreadonly" placeholder="请输入残疾证号" @input="inputChange"/>
        </el-form-item>
        <el-form-item label="残疾类别">
          <el-select v-model="treatData.disabilitytype" placeholder="请选择残疾类别" :disabled="sdisabled" @change="seltChange">
            <el-option v-for="item in distypeData" :key="item.dicid" :value="item.dicid" :label="item.dicname"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="残疾等级">
          <el-select v-model="treatData.disabilityclass" placeholder="请选择残疾等级" :disabled="sdisabled" @change="seltChange">
            <el-option v-for="item in dislevelData" :key="item.dicid" :value="item.dicid" :label="item.dicname"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="残疾详情">
          <el-input v-model="treatData.disabilitydetails" :readonly="sreadonly" placeholder="请输入残疾详情" @input="inputChange"/>
        </el-form-item>
        <el-form-item label="有效期开始时间">
          <el-date-picker v-model="treatData.disabilitydate" type="date" :readonly="sreadonly" placeholder="请选择有效期开始时间" @change="seltChange"></el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="是否目测评定">
          <el-select v-model="treatData.disabilitycansee" placeholder="请选择是否目测评定" :disabled="sdisabled" @change="seltChange">
            <el-option :value="0" label="否"></el-option>
            <el-option :value="1" label="是"></el-option>
          </el-select>
        </el-form-item>
      ...
      <div class="itembox">
        ...
        <el-form-item label="人员类别">
          <el-select v-model="treatData.veterantype" placeholder="请选择人员类别" :disabled="vdisabled" @change="seltChange">
            <el-option v-for="item in veterperData" :key="item.dicid" :value="item.dicid" :label="item.dicname"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="是否悬挂光荣牌">
          <el-select v-model="treatData.veteranhonour" placeholder="请选择是否悬挂光荣牌" :disabled="vetdisabled" @change="vetChange">
            <el-option :value="0" label="否"></el-option>
            <el-option :value="1" label="是"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="申请悬挂光荣牌时间" class="overline">
          <el-date-picker v-model="treatData.veteranhonourdate" type="date" :readonly="vetreadonly" placeholder="请选择申请悬挂光荣牌时间" @change="seltChange"></el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="现工作单位(含离退休前单位)" class="overline">
          <el-input v-model="treatData.veteranworkunit" :readonly="vreadonly" placeholder="请输入现工作单位(含离退休前单位)" @input="inputChange"/>
        </el-form-item>
        <el-form-item label="享受国家抚恤补助金情况" class="overline">
          <el-select v-model="treatData.veteransubsidy" placeholder="请选择享受国家抚恤补助金情况" :disabled="vdisabled" @change="seltChange">
            <el-option :value="0" label="否"></el-option>
            <el-option :value="1" label="是"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="入伍或参加工作时间" class="overline">
          <el-date-picker v-model="treatData.veterandate" type="date" :readonly="vreadonly" placeholder="请选择入伍或参加工作时间" @change="seltChange"></el-date-picker>
        </el-form-item>
        <el-form-item label="退役或离、退休时间" class="overline">
          <el-date-picker v-model="treatData.veteranretiredate" type="date" :readonly="vreadonly"  placeholder="请选择退役或离退休时间" @change="seltChange"></el-date-picker>
        </el-form-item>
        ...
        <el-form-item label="退役(退休或复员)证件号" class="overline">
          <el-input v-model="treatData.veterancardid" :readonly="vreadonly" placeholder="请输入退役(退休或复员)证件号" @input="inputChange"/>
        </el-form-item>
      </div>
      <div class="btnbox">
        <el-button v-if="partype != 2" type="primary" size="medium" :disabled="btndisabled" @click="saveTreat">保 存</el-button>
        <el-button v-if="partype != 2" plain size="medium" :disabled="btndisabled" @click="resetTreat">重 置</el-button>
...
<script>
import {getDictionaryList,putCivilData,getCivilDetail} from "../api/levrest";
