    ...
    <el-form :model="goverData" :inline="true" status-icon label-width="110px">
      <div class="itembox" v-if="!showbox">
        ...
        <el-form-item label="进入党支部日期" class="overline">
          <el-date-picker v-model="goverData.joinpartmentdate" :readonly="preadonly" type="date" placeholder="请选择进入党支部日期"
            value-format="yyyy-MM-dd" @change="seltChange"></el-date-picker>
        </el-form-item>
        <el-form-item label="入党日期">
          <el-date-picker v-model="goverData.joindate" :readonly="preadonly" type="date" placeholder="请选择入党日期"
            value-format="yyyy-MM-dd" @change="seltChange"></el-date-picker>
        </el-form-item>
        <el-form-item label="入党时所在党支部" class="overline">
          <el-input v-model="goverData.olddepartment" :readonly="preadonly" placeholder="请输入入党时所在党支部"
            @input="inputChange" />
        </el-form-item>
        ...
        <el-form-item label="转正日期">
          <el-date-picker v-model="goverData.officialdate" :readonly="preadonly" type="date" placeholder="请选择转正日期"
            value-format="yyyy-MM-dd" @change="seltChange"></el-date-picker>
        </el-form-item>
        <el-form-item label="转正情况">
          <el-input v-model="goverData.officialcondition" :readonly="preadonly" placeholder="请输入转正情况"
            @input="inputChange" />
        </el-form-item>
      ...
      <div class="itembox" v-if="!showactive">
        ...
        <el-form-item label="积极分子状态">
          <el-select v-model="goverData.activist" placeholder="请选择积极分子状态" :disabled="actdisabled" @change="actChange">
            <el-option v-for="item in activistData" :key="item.dicid" :value="item.dicid"
              :label="item.dicname"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="所属支部">
          <el-input v-model="goverData.activistdepartment" :readonly="areadonly" placeholder="请输入所属支部"
            @input="inputChange" />
        </el-form-item>
        <el-form-item label="成为积极分子年份" class="overline">
          <el-date-picker v-model="goverData.activistdate" type="year" :readonly="areadonly" value-format="yyyy"
            placeholder="请选择成为积极分子年份" @change="seltChange"></el-date-picker>
        </el-form-item>
        <el-form-item label="申请时间">
          <el-date-picker v-model="goverData.proposerdate" type="date" :readonly="areadonly" value-format="yyyy-MM-dd"
            placeholder="请选择申请时间" @change="seltChange"></el-date-picker>
        </el-form-item>
        <el-form-item label="支部通过时间">
          <el-date-picker v-model="goverData.passdate" type="date" :readonly="areadonly" value-format="yyyy-MM-dd"
            placeholder="请选择支部通过时间" @change="seltChange"></el-date-picker>
        </el-form-item>
        <el-form-item label="党委备案日期">
          <el-date-picker v-model="goverData.recordsdate" type="date" :readonly="areadonly" value-format="yyyy-MM-dd"
            placeholder="请选择党委备案日期" @change="seltChange"></el-date-picker>
        </el-form-item>
      ...
      <div class="btnbox">
        <el-button v-if="partype != 2" type="primary" size="medium" :disabled="btndisabled" @click="saveGover">
          保 存
        </el-button>
        <el-button v-if="partype != 2" plain size="medium" :disabled="btndisabled" @click="resetGover">
          重 置
        </el-button>
