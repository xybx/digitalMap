  ...
  <div class="healinfo">
    ...
    <el-form ref="healData" :model="healData" :inline="true" status-icon label-width="110px">
      <div class="itembox">
        ...
        <el-form-item label="参保群体(参保类型)" class="cb">
...
<!--          </el-select>-->
      ...
      <div class="itembox">
        ...
        <el-form-item label="最近一次核酸检测时间" class="overline">
          <el-date-picker v-model="healData.detectdata" type="datetime" :readonly="vreadonly" :picker-options="pickerOptions" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择最近一次核酸检测时间" @change="seltChange"></el-date-picker>
        </el-form-item>
        <el-form-item label="核酸监测结果(阴性、阳性)" class="overline">
          <el-input v-model="healData.detectresult" :readonly="vreadonly" placeholder="请输入第三针疫苗接种门诊" @input="inputChange"/>
        </el-form-item>
      </div>
      <div class="btnbox">
...
import {getDictionaryList, getMedicalDetail,putMedicalData} from "../api/resident";
