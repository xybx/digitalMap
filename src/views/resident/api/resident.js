...
export function getMemberDetail(params) {
  return request({
    url: '/family/getfamilybymemberid',
    method: 'get',
    params
  })
}
...
export function getPovertyDetail(params) {
  return request({
    url: '/family/getpovertybymemberid',
    method: 'get',
    params
  })
}
...
export function getMedicalDetail(params) {
  return request({
    url: '/family/getmedicalbymemberid',
    method: 'get',
    params
  })
}
...
export function getLetterDetail(params) {
  return request({
    url: '/family/getlettersbymenberid',
    method: 'post',
    params
  })
}
...
export function getProcess(params) {
  return request({
    url: '/familyimport/getimportschedule',
    method: 'get',
    params
  })
}
