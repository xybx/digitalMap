<template>
  <div class="trial">
    <el-card class="box-card">
      ...
      <div class="text item">
        ...
        <el-table v-loading="tabloading" :data="tableData" border tooltip-effect="dark" :element-loading-text="loadingText">
          ...
          <el-table-column label="操作" align="center">
            <template v-slot="scope">
              <el-button type="danger" @click="acessClick(scope.row.pid)">通过</el-button>
      ...
      <petdialog :trial="true" ref="pdialog" @getData="getData"/>
      <rejectdialog ref="rdialog" :trial="true" @getData="getData"/>
    </el-card>
  </div>
</template>
<script>
...
import {getreviewList} from "@/views/petition/api/petion";
export default {
  name:'trial',
  data(){
    return {
  ...
  methods:{
    ...
    acessClick(pid){
      this.$refs.pdialog.showEdit(pid,3)
    },
    rejectClick(pid){
